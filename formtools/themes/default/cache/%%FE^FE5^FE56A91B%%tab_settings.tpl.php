<?php /* Smarty version 2.6.18, created on 2017-03-24 14:56:29
         compiled from /home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ft_include', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 1, false),array('function', 'template_hook', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 7, false),array('function', 'themes_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 27, false),array('function', 'menus_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 32, false),array('function', 'pages_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 37, false),array('function', 'languages_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 48, false),array('function', 'timezone_offset_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 56, false),array('modifier', 'escape', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 17, false),array('modifier', 'explode', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 119, false),array('modifier', 'in_array', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_settings.tpl', 122, false),)), $this); ?>
...
" /></td>
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_page_titles" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_page_titles'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
...
" /></td>
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_footer_text" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_footer_text'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
        <td class="pad_left_small"><?php echo $this->_tpl_vars['LANG']['word_theme']; ?>
</td>
        <td><?php echo smarty_function_themes_dropdown(array('name_id' => 'theme','default' => $this->_tpl_vars['client_info']['theme'],'default_swatch' => $this->_tpl_vars['client_info']['swatch']), $this);?>
</td>
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_theme" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_theme'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
...
" style="width: 98%" /></td>
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_logout_url" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_logout_url'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
...
&page=settings&refresh_lang_list'" />
        ...
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_language" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_language'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
        ...
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_timezone_offset" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_timezone_offset'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
...
" style="width: 30px" /> <?php echo $this->_tpl_vars['LANG']['word_minutes']; ?>
        ...
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_sessions_timeout" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_sessions_timeout'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
...
" style="width: 80px" /> <span class="medium_grey"><?php echo $this->_tpl_vars['text_date_formatting_link']; ?>
        ...
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_date_format" <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_date_format'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
        <td class="pad_left_small"><?php echo $this->_tpl_vars['LANG']['phrase_forms_page_default_message']; ?>
</td>
        <td><textarea name="forms_page_default_message" style="width:98%"><?php echo $this->_tpl_vars['client_info']['settings']['forms_page_default_message']; ?>
</textarea></td>
        <td align="center"></td>
      </tr>
      </table>
      ...
      <tr>
        ...
        <td class="check_area" align="center"><input type="checkbox" name="may_edit_max_failed_login_attempts"
          <?php if ($this->_tpl_vars['client_info']['settings']['may_edit_max_failed_login_attempts'] == 'yes'): ?>checked="checked"<?php endif; ?> /></td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <div>
            <input type="checkbox" name="required_password_chars[]" value="uppercase" id="rpc1"
              <?php if (((is_array($_tmp='uppercase')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked="checked"<?php endif; ?> />
          ...
          <div>
            <input type="checkbox" name="required_password_chars[]" value="number" id="rpc2"
              <?php if (((is_array($_tmp='number')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked="checked"<?php endif; ?> />
          ...
          <div>
            <input type="checkbox" name="required_password_chars[]" value="special_char" id="rpc3"
              <?php if (((is_array($_tmp='special_char')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked="checked"<?php endif; ?> />
