<?php /* Smarty version 2.6.18, created on 2017-03-24 14:58:27
         compiled from /home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ft_include', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 1, false),array('function', 'views_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 8, false),array('function', 'form_view_fields_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 50, false),array('function', 'submission_listing_quicklinks', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 81, false),array('function', 'eval', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 95, false),array('function', 'template_hook', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 102, false),array('function', 'display_custom_field', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 147, false),array('modifier', 'count', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 26, false),array('modifier', 'default', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 56, false),array('modifier', 'escape', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 63, false),array('modifier', 'cat', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 111, false),array('modifier', 'in_array', '/home1/allcapsc/public_html/workshop/formtools/themes/default/clients/forms/index.tpl', 134, false),)), $this); ?>
...
/icon_forms.gif" border="0" width="34" height="34" /></a></td>
    <td class="title"><?php echo $this->_tpl_vars['form_info']['form_name']; ?>
</td>
    ...
    <?php if ($this->_tpl_vars['view_info']['may_add_submissions'] == 'yes' && $this->_tpl_vars['form_info']['is_active'] == 'yes'): ?>
            ...
            <tr>
              ...
              <td>
                <div id="search_dropdown_section" style="display: none">
				  <input type="text" name="search_date" id="search_date" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['curr_search_fields']['search_date'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['default_date_field_search_value']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['default_date_field_search_value'])); ?>
" />
                </div>
              </td>
            </tr>
...
"
  ...
  <?php echo smarty_function_submission_listing_quicklinks(array('context' => 'client'), $this);?>
...
" method="post">
    ...
    <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_top'), $this);?>
...
px">
            ...
            <?php endif; ?>
              <?php echo smarty_function_display_custom_field(array('form_id' => $this->_tpl_vars['form_id'],'view_id' => $this->_tpl_vars['view_id'],'submission_id' => $this->_tpl_vars['submission_id'],'value' => $this->_tpl_vars['search_row'][$this->_tpl_vars['col_name']],'field_info' => $this->_tpl_vars['curr_field'],'field_types' => $this->_tpl_vars['field_types'],'settings' => $this->_tpl_vars['settings']), $this);?>
    ...
    <div style="padding-top: 5px; padding-bottom: 5px;">
      <div style="float:right; padding:1px" id="display_num_selected_rows"
        ...
        <?php else: ?>
          class="green"
        <?php endif; ?>>
        <?php echo count($this->_tpl_vars['preselected_subids']); ?>

      </div>

      <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_buttons1'), $this);?>
...
" class="red" onclick="ms.delete_submissions()" />
      <?php endif; ?>
      <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_buttons2'), $this);?>
...
" onclick="ms.unselect_all()" />
      <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_buttons3'), $this);?>
...
?add_submission'" />
      ...
      <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_buttons4'), $this);?>

    </div>

    <?php echo smarty_function_template_hook(array('location' => 'client_submission_listings_bottom'), $this);?>
