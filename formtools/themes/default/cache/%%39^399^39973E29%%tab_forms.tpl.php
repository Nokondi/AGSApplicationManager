<?php /* Smarty version 2.6.18, created on 2017-03-24 14:56:32
         compiled from /home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_forms.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ft_include', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_forms.tpl', 1, false),array('function', 'template_hook', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_forms.tpl', 11, false),array('function', 'forms_dropdown', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_forms.tpl', 29, false),array('modifier', 'count', '/home1/allcapsc/public_html/workshop/formtools/themes/default/admin/clients/tab_forms.tpl', 71, false),)), $this); ?>
...
" />
      ...
      <tbody><tr>
        ...
        <th width="160"><?php echo $this->_tpl_vars['LANG']['phrase_available_views']; ?>
</th>
        <th width="90"><?php echo $this->_tpl_vars['LANG']['word_action']; ?>
</th>
        <th width="160"><?php echo $this->_tpl_vars['LANG']['phrase_selected_views']; ?>
</th>
        <th class="del"></th>
      </tr>
...
">
           <td valign="top"><?php echo smarty_function_forms_dropdown(array('name_id' => "form_row_".($this->_tpl_vars['row']),'include_blank_option' => true,'default' => $this->_tpl_vars['form_info']['form_id'],'onchange' => "cf_ns.select_form(".($this->_tpl_vars['row']).", this.value)",'class' => 'selected_form'), $this);?>
</td>
           <td>
...
"><?php echo $this->_tpl_vars['view_row']['view_name']; ?>
           ...
           <td class="del" onclick="return cf_ns.delete_row(<?php echo $this->_tpl_vars['row']; ?>
)"> </td>
         </tr>
