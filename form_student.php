  ...
  <body>
    <div class="container">
      <div class="applicationform">
		Students nominated by their school must complete and submit this form by Monday, January 16, 2017.  Due to the Martin Luther King holiday, forms will be accepted through January 18, 2017.
        <br><br>
		- Although information may be typed directly into the form, it may be advantageous to prepare the longer entries in a word processor and then copy/paste the information into the proper box on the form.
		<br><br>
		- Please note that special fonts and formatting are not retained in the form; simple text-based entries are sufficient.
		<br><br>
		- Please use appropriate upper and lower case letters in the entries.
		<br><br>
		- Please print the form to keep for your own records before submitting.
		<br><br>
	  </div>
	  <div class="applicationform">
